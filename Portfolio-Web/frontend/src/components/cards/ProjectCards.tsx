...
const Date = styled.div<{ theme: Theme }>`
  font-size: 12px;
  margin-left: 2px;
  font-weight: 400;
...
// Define the SetOpenModal type
type SetOpenModal = (value: { state: boolean; project: Project }) => void;

// Define the props for the ProjectCards component
